...
public class Delay2PedalState
{
    ...
    public AmpControlState FeedbackPhase = new(KatanaMkIIParameterCatalog.Delay2FeedbackPhase,
        description:
        "Specifies the phase of the delay sound feedback. Selecting INV inverts the phase. Only when TYPE is SDE-3000.");

    public AmpControlState DelayPhase = new(KatanaMkIIParameterCatalog.Delay2DelayPhase,
        description:
        "Specifies the phase of the delay sound. Selecting INV inverts the phase. Only when TYPE is SDE-3000.");

    public AmpControlState ModSw = new(KatanaMkIIParameterCatalog.Delay2ModSw,
