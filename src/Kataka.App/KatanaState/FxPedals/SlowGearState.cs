...
public class SlowGearState
{
    ...
    public SlowGearState(bool isMod)
    {
        ...
        Sens = new AmpControlState(p[0],
            description:
            "Adjusts the sensitivity of the slow gear. Lower values require stronger picking; higher values allow softer picking to trigger the effect.");
        RiseTime = new AmpControlState(p[1],
            description: "Sets the time needed for the volume to reach its maximum from the moment you begin picking.");
