...
public class LimiterState
{
    ...
    public LimiterState(bool isMod)
    {
        ...
        Ratio = new AmpControlState(p[3],
            description: "Selects the compression ratio used with signals in excess of the threshold level.");
