...
public class RingModState
{
    ...
    public RingModState(bool isMod)
    {
        ...
        Mode = new AmpControlState(p[0],
            description:
            "Selects the mode for the ring modulator. NORMAL is a standard ring modulator; INTELLIGENT modulates the oscillation frequency according to the pitch of the input sound.");
