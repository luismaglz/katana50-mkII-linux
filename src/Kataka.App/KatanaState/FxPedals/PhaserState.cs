...
public class PhaserState
{
    ...
    public PhaserState(bool isMod)
    {
        ...
        Resonance = new AmpControlState(p[4],
            description:
            "Determines the amount of resonance (feedback). Increasing the value will emphasize the effect.");
        StepRate = new AmpControlState(p[5],
            description:
            "Sets the cycle of the step function that changes the rate and depth. Set to Off when not using the step function.");
