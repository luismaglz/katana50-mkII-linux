...
public class HarmonistState
{
    ...
    public HarmonistState(bool isMod)
    {
        ...
        Harmony1 = new AmpControlState(p[1],
            description: "Determines the pitch of the sound added to the input sound for harmony 1.");
        Level1 = new AmpControlState(p[2], description: "Adjusts the volume of the harmony 1 sound.");
        Harmony2 = new AmpControlState(p[3],
            description: "Determines the pitch of the sound added to the input sound for harmony 2.");
