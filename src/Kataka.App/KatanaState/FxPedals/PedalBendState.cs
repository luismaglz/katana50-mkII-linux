...
public class PedalBendState
{
    ...
    public PedalBendState(bool isMod)
    {
        ...
        Pitch = new AmpControlState(p[0],
            description: "This sets the pitch at the point where the expression pedal is all the way down.");
        PedalPos = new AmpControlState(p[1],
            description:
            "Adjusts the pedal position for pedal bend. This parameter is used after it has been assigned to an expression pedal or similar controller.");
