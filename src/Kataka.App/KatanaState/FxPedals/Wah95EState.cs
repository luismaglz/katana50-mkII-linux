...
public class Wah95EState
{
    ...
    public Wah95EState(bool isMod)
    {
        ...
        PedalPos = new AmpControlState(p[0],
            description:
            "Adjusts the position of the wah pedal. This parameter is used after it has been assigned to an EXP Pedal or similar controller.");
        PedalMin = new AmpControlState(p[1],
            description: "Selects the tone produced when the heel of the EXP Pedal is depressed.");
        PedalMax = new AmpControlState(p[2],
