...
public class HumanizerState
{
    public HumanizerState(bool isMod)
    {
        ...
        Mode = new AmpControlState(p[0], description: "Sets the mode that switches the vowels. PICKING switches based on picking; AUTO switches automatically by rate and depth.");
