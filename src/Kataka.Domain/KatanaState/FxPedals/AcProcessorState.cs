...
public class AcProcessorState
{
    ...
    {
        var p = isMod ? KatanaMkIIParameterCatalog.ModAcProcessorParams : KatanaMkIIParameterCatalog.FxAcProcessorParams;
        Type       = new AmpControlState(p[0], description: "Selects the modeling type. Small models a small-bodied acoustic; Medium is a standard acoustic; Bright is a bright acoustic; Power is a powerful acoustic.");
        ...
        MidFreq    = new AmpControlState(p[3], description: "Specifies the frequency range to be adjusted with the Mid control.");
