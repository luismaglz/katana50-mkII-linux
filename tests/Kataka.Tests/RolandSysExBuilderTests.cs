...
public sealed class RolandSysExBuilderTests
{
    ...
    public void KatanaMkIIPatchLevelReadRequest_UsesExpectedAddressAndChecksum()
    {
        ...
        Assert.Equal(
            [0xF0, 0x41, 0x00, 0x00, 0x00, 0x00, 0x33, 0x11, 0x60, 0x00, 0x06, 0x4C, 0x00, 0x00, 0x00, 0x01, 0x4D, 0xF7],
            request.Bytes);
    }
    ...
    public void KatanaMkIIParameterCatalog_ExposesConfirmedPanelVariationAddresses()
    {
        ...
        Assert.Null(KatanaMkIIParameterCatalog.PanelEffects.Single(effect => effect.Key == "delay2").VariationParameter);
    }
    ...
    public void KatanaMkIIParameterCatalog_ExposesConfirmedTypeRangesAndSkippedValues()
    {
        ...
        Assert.Equal<byte>([0x05, 0x08, 0x0B, 0x0D, 0x11, 0x18, 0x1E, 0x20, 0x21, 0x22], KatanaMkIIParameterCatalog.ModType.SkippedValues);
    ...
    public void KatanaMkIICurrentPanelChannelReadRequest_UsesExpectedAddressAndChecksum()
    {
        ...
        Assert.Equal(
            [0xF0, 0x41, 0x00, 0x00, 0x00, 0x00, 0x33, 0x11, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x7D, 0xF7],
            request.Bytes);
    }
    ...
    {
        var reply = new SysExMessage([0xF0, 0x41, 0x00, 0x00, 0x00, 0x00, 0x33, 0x12, 0x60, 0x00, 0x06, 0x51, 0x36, 0x2A, 0x2C, 0x32, 0x2B, 0x2A, 0x36, 0xF7]);
